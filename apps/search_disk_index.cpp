                      ...
                      const std::vector<std::string> &query_filters, const bool use_reorder_data = false)
{
    ...
    if (num_nodes_to_cache > 0 && file_exists(warmup_query_file))
    {
        diskann::cout << "Using sample-query frequency cache (hop-depth weighted, gorgeous-aware)" << std::endl;
        _pFlashIndex->generate_cache_list_from_sample_queries(warmup_query_file, 15, 6,
